...
<h3>Furniture</h3>
     ...
     <div class="module-body m-t-20">
        ...
        <a href="http://facebook.com/funterior" class='active'><i class="icon fa fa-facebook"></i></a>
        <a href="#"><i class="icon fa fa-twitter"></i></a>
        <a href="#"><i class="icon fa fa-linkedin"></i></a>
        <a href="https://api.whatsapp.com/send?phone=918778325240" ><i class="icon fa fa-phone"></i></a>
        <a href="#"><i class="icon fa fa-pinterest"></i></a>
<!--<a href="https://api.whatsapp.com/send?phone=919629279644"><i class="icon fa fa-whatsapp></a>-->
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">info@radssoon.com</a></span>
                </div>
            </li>
